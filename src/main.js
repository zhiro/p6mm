...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function simulateSound() {
        ...
        for (let mic of microphones) {
            console.log(`Calculating arrival time for microphone ${mic.id} at (${mic.latitude}, ${mic.longitude})`);
            let arrivalTime = calculateArrivalTime(mic.latitude, mic.longitude, soundLat, soundLon);
            console.log(`Microphone ${mic.id} at (${mic.latitude}, ${mic.longitude}) will receive sound at ${arrivalTime.toFixed(2)} seconds`);
            ...
            console.log(`Microphone ${mic.id} registered time difference of arrival of ${timeDifference.toFixed(2)} seconds`);
        }
